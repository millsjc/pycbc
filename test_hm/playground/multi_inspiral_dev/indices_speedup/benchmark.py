...
# Check if the outputs of both implementations are the same
if (indices_1 == indices_2).all():
    print("The outputs of both implementations are the same, e.g. see the first 3 indices:")
else:
    print("The outputs of both implementations are different")
